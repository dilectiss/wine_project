...
class VagSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.wine-searcher.com/critics-36-vinous+antonio+galloni']
...
# changing the value of the range
    def start_requests(self):
    	for i in range(0, 20):
    		yield Request(
    			url='https://www.wine-searcher.com/critics-36-vinous+antonio+galloni/{0}'.format(i*25+1), 
