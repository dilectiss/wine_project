# -*- coding: utf-8 -*-
# crawler for bettane and desseauve's ratings
...
class BettaneAndDesseauveSpider(scrapy.Spider):
    name = 'bettane_and_desseauve'
    allowed_domains = ['www.wine-searcher.com']
    start_urls = ['http://www.wine-searcher.com/critics-14-bettane+et+desseauve']
...
# changing the value of the range
    def start_requests(self):
    	for i in range(0, 400):
    		yield Request(
    			url='http://www.wine-searcher.com/critics-14-bettane+et+desseauve/{0}'.format(i*25+1), 
